  ...
  return (
    ...
    >
      ...
      <div className="space-x-4">
        <Link to="/internship/1" className="bg-violet-500 px-6 py-3 rounded text-white hover:bg-violet-700 transition">
          Internship 1
        </Link>
        <Link to="/internship/2" className="bg-violet-500 px-6 py-3 rounded text-white hover:bg-violet-700 transition">
          Internship 2
        </Link>
      </div>
    </div>
